...
urlpatterns = [
    ...
    path("hansel-gretel.html/", hanselYGretel, name="hansel_gretel"),
    path("gato-con-botas.html", gatoConBotas, name="gato_con_botas"),
    path("tres-cerditos.html/", tresCerditos, name="tres_cerditos"),
